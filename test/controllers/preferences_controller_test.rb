...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { animal: @preference.animal, conversation: @preference.conversation, music: @preference.music, smoke: @preference.smoke, user_id: @preference.user_id } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { animal: @preference.animal, conversation: @preference.conversation, music: @preference.music, smoke: @preference.smoke, user_id: @preference.user_id } }
